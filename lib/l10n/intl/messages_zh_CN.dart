...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allowBypass": MessageLookupByLibrary.simpleMessage("允许应用绕过 TUN"),
    "allowBypassDesc": MessageLookupByLibrary.simpleMessage("开启后部分应用可绕过 TUN"),
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "Conceal FlClash Android 是面向 SukiSU Ultra root TUN 透明代理改造的 FlClash 分支。",
    ),
    ...
    "startVpn": MessageLookupByLibrary.simpleMessage("正在启动 TUN 代理..."),
    "status": MessageLookupByLibrary.simpleMessage("状态"),
    "statusDesc": MessageLookupByLibrary.simpleMessage("关闭后将使用系统DNS"),
    "stop": MessageLookupByLibrary.simpleMessage("暂停"),
    "stopVpn": MessageLookupByLibrary.simpleMessage("正在停止 TUN 代理..."),
    ...
    "vpnEnableDesc": MessageLookupByLibrary.simpleMessage(
      "启动 SukiSU Ultra root TUN 透明代理",
    ),
    "vpnTip": MessageLookupByLibrary.simpleMessage("重启 TUN 代理后改变生效"),
